...
@Component({
  selector: 'app-requested-stationery',
  templateUrl: './requested-stationery.component.html',
  styleUrls: ['./requested-stationery.component.css']
  })
export class RequestedStationeryComponent implements OnInit {
  ...
  stationeries:any;deleteLoader:Boolean=false;sationery_id:any;
  ...
  deleteRequest(template: TemplateRef<any>,stationery_id)
  {
    this.modalRef = this.modalService.show(template, this.config);
    this.sationery_id=stationery_id;
  }
  confirm()
  {
    this.deleteLoader=true;
    this.api.deleteRequestedStationery(this.sationery_id).subscribe(res => {
      this.user_data=res;
      this.toastr.showSuccess('Request Deleted');
      this.modalRef.hide();
      this.deleteLoader=false;
      this.refreshData();
      }, (err) =>
      {
        this.toastr.showError(err.error);this.deleteLoader=false;
        });
  }
