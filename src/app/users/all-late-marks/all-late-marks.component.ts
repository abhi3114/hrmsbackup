...
export class AllLateMarksComponent implements OnInit {
  ...
  constructor(private router:Router,private api:AllLateMarksService,private monthandyear:MonthYearService,private modalService: BsModalService,public toastr: ToastrManager)
  {
