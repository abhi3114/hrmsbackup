...
export class ApprovedLateMarksComponent implements OnInit {
  ...
  constructor(private router:Router,private api:ApprovedLateMarksService,private monthandyear:MonthYearService,private modalService: BsModalService,public toastr: NotificationService)
  {
  ...
  validateLateMarksForm()
  {
    ...
    this.api.getApprovedLateMarks(start_date,end_date).subscribe(res => {
      this.api_data=res;
