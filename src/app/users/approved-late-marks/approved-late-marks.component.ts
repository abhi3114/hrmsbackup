...
export class ApprovedLateMarksComponent implements OnInit {
  ...
  constructor(private router:Router,private api:ApprovedLateMarksService,private monthandyear:MonthYearService,private modalService: BsModalService,public toastr: ToastrManager)
  {
