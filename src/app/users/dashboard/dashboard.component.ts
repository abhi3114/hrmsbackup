...
export class DashboardComponent implements OnInit {
  ...
  validateSalarySlipForm()
  {
    this.api.getUserSalarySlip(this.salarySlipDownloadData.selectedmonth,this.salarySlipDownloadData.selectedyear).subscribe(res => {
      ...
      this.pdfObj=  this.pdf.createPdf(this.buildPdf(  this.user_data));
                    ...
                    hLineColor: function(i, node) {
                      ...
                      },
                      {
                        ...
                        table: {
                          ...
                          [{text: 'Basic', style: 'tableheadContent',border: [true, true, true, false]}, {text:(basic), style: 'tableContent', alignment: 'right',border: [true, true, true, false]},

                          {text: 'Professional Tax', style: 'tableheadContent',border: [true, false, true, false]}, {text:(professionalTax), style: 'tableContent', alignment: 'right',border: [true, false, true, false]}],

                          [{text: 'HRA', style: 'tableheadContent',border: [true, false, true, false]}, {text: (hra), style: 'tableContent', alignment: 'right',border: [true, false, true, false]},
                          ...
                          [{text: 'Travelling Allowance', style: 'tableheadContent',border: [true, false, true, false]}, {text: (travel), style: 'tableContent', alignment: 'right',border: [true, false, true, false]},
                          ...
                          [{text: 'Other Earnings', style: 'tableheadContent',border: [true, false, true, false]}, {text:(otherexpense) , style: 'tableContent', alignment: 'right',border: [true, false, true, false]},

                          {text: 'Earlier PF Deduction', style: 'tableheadContent',border: [true, false, true, false]},  {text: (earlierepf), style: 'tableContent', alignment: 'right',border: [true, false, true, false]}],

                          [{text: 'Incentives', style: 'tableheadContent',border: [true, false, true, false]}, {text:(finalIncentive), style: 'tableContent', alignment: 'right',border: [true, false, true, false]},

                          {text: 'Other Deduction', style: 'tableheadContent',border: [true, false, true, false]},  {text: (od), style: 'tableContent', alignment: 'right',border: [true, false, true, false]}],

                          [{text: 'Special Allowance', style: 'tableheadContent',border: [true, false, true, false]}, {text:(special), style: 'tableContent', alignment: 'right',border: [true, false, true, false]},

                          {text: 'Salary Advance', style: 'tableheadContent',border: [true, false, true, false]},{text: (sa), style: 'tableContent', alignment: 'right',border: [true, false, true, false]}],

                          [{text: 'Overtime', style: 'tableheadContent',border: [true, false, true, false]}, {text:(ot), style: 'tableContent', alignment: 'right',border: [true, false, true, false]},

                          {text: 'ESIC Deduction', style: 'tableheadContent',border: [true, false, true, false]}, {text: (esic), style: 'tableContent', alignment: 'right',border: [true, false, true, false]}],

                          [{text: 'Arrears', style: 'tableheadContent',border: [true, false, true, false]}, {text:(ar), style: 'tableheadContent', alignment: 'right',border: [true, false, true, false]},
                          ...
                          [{text: 'Total', style: 'tableHeader',border: [true, true, false, false]}, {text: 'Gross Earnings: '+(Earnings), style: 'grossContent', alignment: 'right',border: [false, true, true, false]},

                          {text: 'Total', style: 'tableHeader',border: [true, true, false, false]}, {text:'Gross Deductions: '+(Deductions) , style: 'grossContent', alignment: 'right',border: [false, true, true, false]}],

                          [{text: 'Net Salary Payable', style: 'tableHeader',colSpan: 2, alignment: 'left'}, {},{text:(salData.amount), style: 'grossContent',colSpan: 2, alignment: 'right',border: [false, true, true, false]}, {}],

                          [{text: 'Net Salary Payable in Words', style: 'tableHeader',colSpan: 2, alignment: 'left'}, {},{text:(salData.amount), style: 'grossContent',colSpan: 2, alignment: 'right'}, {}],
