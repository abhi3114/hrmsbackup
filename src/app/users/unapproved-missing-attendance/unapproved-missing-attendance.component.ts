...
export class UnapprovedMissingAttendanceComponent implements OnInit {
  ...
  modalRef: BsModalRef;
  constructor(private router:Router,private api:UnapprovedMissingAttendanceService,private monthandyear:MonthYearService,private modalService: BsModalService,public toastr: NotificationService)
  {
